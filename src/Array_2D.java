...
//                                    Subscriptions subsOBJ = new Subscriptions(subsID, subsName, agreementPrice, subsDuration, validDate, subsActive, subsDesc);
//                                    subs.add(subsOBJ);
...
//                } else if (choice1 == 3) {
//                    /**
//                     * Number of Users and Subscriptions in the ArrayList should be same i.e. user_useable.size() == subs_useable.size()
//                     */
//
//                    // Converting ArrayList to Array
//                    Users[] userUseableArray = user_useable.toArray(new Users[0]);
//                    Subscriptions[] subsUseableArray = subs_useable.toArray(new Subscriptions[0]);
//
//                    // Passing data to 2D array
////                    2 columns(Users, Subscription) and 100 rows
//                    Object[][] userSubscriptionInfo = new Object[userUseableArray.length][2];
//                    for (int i = 0; i < userUseableArray.length; i++) {
////                        Users column
//                        userSubscriptionInfo[i][0] = userUseableArray[i];
////                        Subscriptions column
//                        userSubscriptionInfo[i][1] = subsUseableArray[i];
//                    }
//
//                    subscriber.displayUserSubscriptionInfo(userSubscriptionInfo);
//                }
//            }
//
//            scanner.close();
